...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product.php"> 			 <i class="icon-th-list"></i>Productos</a></li>
	...
	<legend>Sobre nosotros</legend>
		<div id="content">
			<legend><h3>Mission</h3></legend>
					<h4 style="text-indent:60px;">Nuestra mision es dar un buen servicio a nuestros clientes a traves de la venta de libro especialmente divididos por tres autores mas reconocido, porque somos mas que una libreria..</h4>
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Para el 2021 la primera eleccion cuando la gente piense en  una libreria, destacandonos por nuestro servicio de calidad e innovacion en la forma de interactuar con nuestros clientes.
