...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php">Roberth R.R</a></li>
				<li>|</li>
				<li><a href="football1.php" class="active" style="color:#111;">Gabriel G.M</a></li>
				<li>|</li>
				<li><a href="running1.php">Julio Cortazar</a></li>
			</ul>
