	...
	<div id="header">
		...
		<label>Griselda</label>
			<ul>
				...
				<li><a href="#login"   data-toggle="modal"></a>Iniciar sesion</li>
			</ul>
	</div>
	...
	<div class="nav">	
		...
		<div id="content">
			<legend>Preguntas frecuentes</legend>
					...
					<h4>¿CUANDO CONSEGUIRE MIS ORDENES?</h4>
						<p style="text-indent:60px;">Enviaremos su producto 1 dia en tlapa y tardaremos 2 dias fuera de tlapa.</p>
				<hr>
					<h4>¿COMO PUEDO PAGAR MIS PEDIDOS?</h4>
					<p style="text-indent:60px;">Solo a traves de PAYPAL.</p>
