...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="number" name="qty" placeholder="Disponibles" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="hidden" name="category" value="football"></td>
								<!-- //checa xian aqui modificastes -->
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Productos</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Destacado</a></li>
			...
			<li><a href="transaction.php">Transacción</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Gabriel G.M</h2></center></div>
			<br />
