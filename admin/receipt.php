...
<body>
	...
	<label style="font-size:25px;">Libreria Griselda.</label>
	<label style="font-size:20px;">Official</label>
		<tr>
			<th><h5>Cantidad</h5></td>
			<th><h5>Nombre del Producto</h5></td>
			<th><h5>Dimensío</h5></td>
			<th><h5>Precio</h5></td>
		</tr>
	...
	<div class="add"><a onclick="javascript:printDiv('printablediv')" name="print" style="cursor:pointer;" class="btn btn-info"><i class="icon-white icon-print"></i>Imprimir Ticket</a></div>
	</div>
	</form>
			</div>
			</div>
