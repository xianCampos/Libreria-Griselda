...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Size" style="width:250px;" maxLength="5" required></td>
							</tr>
							<tr>
	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="customer.php">Cientes</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Destacados</h2></center></div>
			<br />
