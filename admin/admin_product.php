...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="tamaño" style="width:250px;" maxLength="5" required></td>
							</tr>
							<tr>
	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Novedades</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Roberth R.R</h2></center></div>
			<br />
