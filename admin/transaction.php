...
<body>
	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Productos</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Producto Destacado</a></li>
			...
			<li><a href="transaction.php">Transaciones</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Transaccion	</h2></center></div>
			<br />
