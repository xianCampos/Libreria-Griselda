...
<body>
	...
	<br>
		...
		<div id="add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<h3 id="myModalLabel">Agregar Proucto</h3>
			</div>
				<div class="modal-body">
					...
					<center>
						<table>
							...
							?>
							<tr>
								<td><input type="text" name="product_name" placeholder="Nombre" style="width:250px;" required></td>
							<tr/>
							<tr>
								<td><input type="text" name="product_price" placeholder="Precio" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="text" name="product_size" placeholder="Dimensión" style="width:250px;" maxLength="5" required></td>
							</tr>
							<tr>
								<td><input type="text" name="brand" placeholder="Categoria" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="number" name="qty" placeholder="Disponible" style="width:250px;" required></td>
							</tr>
							<tr>
	...
	<div id="leftnav">
		<ul>
			<li><a href="admin_home.php" style="color:#333;">Tablero</a></li>
			<li><a href="admin_home.php">Producto</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Features</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Roberth R.R</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Gabriel G.M</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Julio Cortazar</a></li>
				</ul>
			</li>
			<li><a href="transaction.php">Transaccíon</a></li>
			<li><a href="customer.php">Clientes</a></li>
			<li><a href="message.php">Mensajes</a></li>
			<li><a href="order.php">Orden</a></li>
		</ul>|
	</div>
	
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Julio Cortazar</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Buscar Producto" id="filter"></label>
			<br />
