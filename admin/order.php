...
<body>
	...
	<div id="leftnav">
		<ul>
			...
			<li><a href="admin_home.php">Productos</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Caracteristicas</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Ricky</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Pedido</h2></center></div>
			<br />
				<div style='width:975px;' class="alert alert-info">
					  <table class="table table-hover">	
						<thead>	
							<th>Libro</th>
							<th>Transacción No.</th>
							<th>Cantidad</th>
						</thead>
						  <tbody>
							<?php 
							...
							$amnt = $r3['sum(amount)'];
							echo "<tr><td></td><td>TOTAL : </td> <td><b>$ ".formatMoney($amnt)."</b></td></tr>";
							}
							?>
						  </tbody>
					    </table>
