		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						...
						<input type="text" name="mi" placeholder="Primer Apellido" maxlength="1" required>
						<input type="text" name="lastname" placeholder="Segundo Apellido" required>
						<input type="text" name="address" placeholder="Dirección" style="width:430px;"required>
						<input type="text" name="country" placeholder="Municipio" required>
						<input type="text" name="zipcode" placeholder="Código postal" required maxlength="4">
						<input type="text" name="mobile" placeholder="Número de celular" maxlength="11">
						<input type="text" name="telephone" placeholder="Número de teléfono" maxlength="8">
						<input type="email" name="email" placeholder="Correo Electronico" required>
						<input type="password" name="password" placeholder="Contraseña" required>
						</center>
					</div>
				<div class="modal-footer">
					<input type="submit" class="btn btn-primary" name="signup" value="Regístrate">
...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="product.php"><i class="icon-th-list"></i>Producto</a>
				<li><a href="aboutus.php"><i class="icon-bookmark"></i>Sobre nosotros</a></li>
				<li><a href="contactus.php"><i class="icon-inbox"></i>Contáctenos</a></li>
				<li><a href="privacy.php"><i class="icon-info-sign"></i>Política de privacidad</a></li>
				<li><a href="faqs.php"><i class="icon-question-sign"></i>Preguntas frecuentes</a></li>
				<li><a href="bucar_usuario.php"><i class=""></i>Buscar</a></li>
	...
	<div id="carousel">
	 ...
	 <div id="video">
		<video controls autoplay width="498px" height="300px">
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>Productos Destacados</legend></h2></center>
			<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/xan.campos.7"><li>Facebook</li></a>
						<a href="http://www.twitter.com/xan.campos.7"><li>Twitter</li></a>
