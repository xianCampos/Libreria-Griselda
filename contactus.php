		...
		<div id="content">
			<form method="post">
				<table style="position:relative; left:25%;">
					...
					<tr>
						<td style="font-size:20px;">Mensaje:</td><td><textarea name="message" style="width:400px; height:300px;" required></textarea></td>
					</tr>
					<tr>
						<td></td><td><button class="btn btn-info" name="send" style="width:300px;"><i class="icon icon-ok icon-white"></i>Enviar</button>&nbsp;<a href="index.php"><button class="btn btn-danger" style="width:110px;"><i class="icon icon-remove icon-white"></i>Cancelar</button></a></td>
					</tr>
				</table> 
			</form> 
		</div>
