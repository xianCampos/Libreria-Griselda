...
<div id="container">
		...
		?>
				<div>
					<center>
						...
						<?php echo "<a href='cart.php?id=".$id."&action=add'><input type='submit' class='btn btn-inverse' name='add' value='Agregar al carrito'></a> &nbsp;  <a href='product1.php'><button class='btn btn-inverse'>Regresar</button></a> " ?>
					</center>
				</div>
		<?php }?>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of xianbooxk Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">XianBoock</p>
		</div>
