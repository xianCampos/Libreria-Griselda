...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product1.php"> 			 <i class="icon-th-list"></i>Productos</a></li>
	...
	<table class="table">
	<label style="font-size:25px;">My carrito</label>
		<tr>
			<th><h3>Imagen</h3></td>
			<th><h3>Nombre</h3></th>
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<font color='#111' class='alert alert-error' style='float:right'>Vacio</font>";
...
?>
	...
	<?php echo "<button name='pay_now' type='submit' class='btn btn-inverse btn-lg' >Comprar</button>";
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">XianBoock Inc. 2019</p>
		</div>
			
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/xian.5"><li>Facebook</li></a>
